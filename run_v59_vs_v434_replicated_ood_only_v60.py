#!/usr/bin/env python3
"""Run the sealed replicated V59-versus-V434 OOD QA/prose gate."""
...
import stage_v59_candidate_vllm_v60 as v59_stage
...
LOGICAL_REPLICAS = {
    ...
    "v59_candidate": ("v59_candidate_a", "v59_candidate_b"),
}
...
STAGE_EXPECTED = {
    ...
    "v59_candidate": {
        "weights": "e189cfb9fcd6c55700babae91111266825522fc46ddbd53fc0574786711eccae",
        "config": "b2bf4816802328893825be9ed7634b109ed400e17774f6bb98defe2e26ad06b5",
        "manifest_file": "c0e8c322f8c373dadd66506a2ad3859b7f9f18e56e56ff7b387999fb060f3d0e",
        "manifest_content": "4b56da407f9a764157e6c9970ad1cc0b3695ad8e6ea9ee691cf73e274ba26bf6",
...
DIRECT_PAIRS = (
    ("replica_a", "v434_equal_a", "v59_candidate_a"),
    ("replica_b", "v434_equal_b", "v59_candidate_b"),
)
GPU_PHASES = ("v60_ood_qa", "v60_ood_prose")
EXPERIMENT = "v60_v59_vs_v434_replicated_ood_only"
RUN_DIR = (ROOT / "experiments/eggroll_es_hpo/runs" / EXPERIMENT).resolve()
ATTEMPT = (RUN_DIR.parent / f".{EXPERIMENT}.attempt.json").resolve()
RAW = (RUN_DIR / "raw_items_v60.json").resolve()
GPU_LOG = (RUN_DIR / "gpu_activity_v60.jsonl").resolve()
FAILURE = (RUN_DIR / "failure_v60.json").resolve()
REPORT = (
    ROOT / "experiments/eval_reports/"
    "v59_vs_v434_replicated_ood_only_v60.json"
).resolve()
DEFAULT_PREREGISTRATION = (
    ROOT / "experiments/eggroll_es_hpo/preregistrations/"
    "v59_vs_v434_replicated_ood_only_v60.json"
).resolve()
BUILDER = (ROOT / "build_v59_vs_v434_ood_preregistration_v60.py").resolve()
TESTS = (ROOT / "test_v59_vs_v434_replicated_ood_only_v60.py").resolve()
...
def _source_seal(logical: str) -> dict:
    ...
    if logical == "v59_candidate":
        return v59_stage.source_seal_v60()
...
def implementation_bindings_v56() -> dict:
    paths = {
        ...
        "stage_v59_runtime": Path(v59_stage.__file__).resolve(),
        "stage_v434_runtime": Path(v434_stage.__file__).resolve(),
        "canonical_stage_runtime": Path(v59_stage.prior.__file__).resolve(),
        ...
        "v59_source_weights": v59_stage.SOURCE / "adapter_model.safetensors",
        "v59_source_config": v59_stage.SOURCE / "adapter_config.json",
        "v59_source_evidence": v59_stage.EVIDENCE,
        "v59_source_p16_gate": v59_stage.P16_GATE,
        "v59_source_internal_report": v59_stage.INTERNAL_REPORT,
        "v59_source_wrapper_report": v59_stage.WRAPPER_REPORT,
        "v434_staged_weights": (
        ...
        "v59_staged_weights": (
            STAGED_BY_LOGICAL["v59_candidate"] / "adapter_model.safetensors"
        ),
        "v59_staged_config": (
            STAGED_BY_LOGICAL["v59_candidate"] / "adapter_config.json"
        ),
        "v59_stage_manifest": (
            STAGED_BY_LOGICAL["v59_candidate"] / "stage_manifest_v44a.json"
        ),
...
def direct_gate_table_v56(ood_qa, prose_details, raw_sink) -> dict:
    ...
    return {
        "comparison": "fixed V59 candidate directly versus exact V434 master",
        "replicas": replicas,
...
def load_preregistration_v56(args) -> dict:
    ...
    if (
        ...
        or value.get("schema") != "v59-vs-v434-replicated-ood-only-v60"
...
def main(argv: list[str] | None = None) -> int:
    ...
    attempt = core.self_hashed({
        "schema": "v60-v59-v434-ood-only-attempt",
        "status": "launching",
    ...
    phase = Phase()
    raw_sink = {"schema": "v60-v59-v434-ood-only-raw-local"}
    ...
    try:
        ...
        report = core.self_hashed({
            "schema": "v60-v59-v434-replicated-ood-only-aggregate",
            ...
            "ood_qa": ood_qa,
            "ood_prose": ood_prose,
            "direct_v59_vs_v434_gate": direct,
        ...
        complete.update({
            "status": "complete",
            "phase": "v60_ood_aggregate_sealed",
            "completed_at_utc": datetime.now(timezone.utc).isoformat(),
            "protected_semantic_access_count": 2,
        ...
        failure = core.self_hashed({
            "schema": "v60-v59-v434-ood-only-failure",
