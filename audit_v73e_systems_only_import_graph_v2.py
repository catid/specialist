#!/usr/bin/env python3
"""Seal the V73E systems-only runtime import closure and synthetic guard gate."""
...
ROOT_MODULES = (
    "run_qwen36_v73e_exact_phase_profiler.py",
    "run_lora_es_v71_v72_profile_calibration_v73e.py",
)
...
MUTABLE_PREREG_BUILDER = (
    "build_qwen36_v73e_exact_phase_profiler_preregistration.py"
)
...
def run_synthetic_guard_tests() -> dict[str, Any]:
    ...
    test_path = (ROOT / TEST_MODULE).resolve()
    return {
        ...
        "test_source_bindings": [{
            "path_identity_sha256": _path_identity(
                TEST_MODULE, "repository-root-test-path-v1"
            ),
            "file_sha256": file_sha256(test_path),
        }],
