...
import qwen36_v73h_exact_phase_profiler_contract as builder
...
def _validate_actor_bootstrap_receipt_v73e(
    ...
    _require(
        ...
        and value.get("bootstrap_mechanism") == ACTOR_GUARD_MECHANISM
        and value.get("guard_was_preinstalled") is True
        and value.get("actor_sitecustomize_installed_before_runtime_imports")
        is True
        and value.get("parent_modules_covered_by_process_start_guard") is True
        and value.get(
...
def validate_target_artifacts_v73e(
    ...
    _require(
        ...
        and guard.get("actor_bootstrap_mechanism") == ACTOR_GUARD_MECHANISM
