#!/usr/bin/env python3
"""Seal deterministic V43L backtracking from exact V43I train-only evidence."""
...
def _v43i_preregistration() -> dict:
    if runtime.v40a.file_sha256(V43I_PREREGISTRATION) != (
        ...
        raise RuntimeError("v43l V43I preregistration file changed")
    ...
    if (
        ...
        raise RuntimeError("v43l V43I preregistration content changed")
    return value


def build_v43l() -> dict:
    parent = _v43i_preregistration()
    evidence = backtracking.load_v43i_evidence_v43l(
    ...
    if (
        ...
        raise RuntimeError("v43l exact restored state/scale derivation changed")
    value = {
        "schema": "matched-lora-es-backtracking-preregistration-v43l",
        ...
        "purpose": (
            "Characterize the untried 0.03125 V43I projection scale and open "
            "0.015625 only if 0.03125 fails the same six train-only gates, without "
        ...
        "v43k_train_only_evidence": predecessor,
        ...
        "recipe": {
            ...
            "scale_policy": (
                "evaluate 0.03125 first; evaluate 0.015625 only after an exact "
                "abort caused by failure of at least one of the six train-only "
                "gates; a post-gate consensus failure does not authorize 0.015625"
            ),
        ...
        "transaction_protocol": {
            ...
            "ratio_0p015625_requires_ratio_0p03125_six_gate_failure": True,
            "ratio_0p03125_consensus_failure_authorizes_ratio_0p015625": False,
        ...
        "implementation_bindings": runtime.implementation_bindings_v43l(),
        "artifacts": {
