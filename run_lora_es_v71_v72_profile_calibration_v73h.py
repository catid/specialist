...
def _validate_worker_bootstrap_receipt_v73e(
    ...
    _require(
        ...
        and row.get("bootstrap_mechanism") == ACTOR_GUARD_MECHANISM
        and row.get("guard_was_preinstalled") is True
        and row.get("actor_sitecustomize_installed_before_runtime_imports")
        is True
        and row.get("parent_modules_covered_by_process_start_guard") is True
        and row.get(
...
def _guard_evidence_v73e(worker_rows) -> dict[str, Any]:
    ...
    return {
        ...
        "actor_bootstrap_mechanism": ACTOR_GUARD_MECHANISM,
