...
HERE=Path(__file__).resolve().parent;sys.path.insert(0,str(HERE));import build_resource_additions_v6 as b
...
class Test(unittest.TestCase):
 ...
 def test_content(self):
  ...
  self.assertEqual(Counter(classify_stratum(r)for r in self.rows),Counter({"resources_general":3}))
 def test_report(self):self.assertEqual(self.report["new_independent_inputs"]["expected_strata"],{"resources_general":3})
