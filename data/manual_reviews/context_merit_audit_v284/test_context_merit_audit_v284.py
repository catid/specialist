#!/usr/bin/env python3
"""Focused regression tests for the v284 upper-cinch nerve-context edit."""
import json
import sys
import tempfile
import unittest
...
import build_context_merit_audit_v284 as b


class V284(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temp = tempfile.TemporaryDirectory(prefix=".test-v284-", dir=HERE)
    ...
    def test_19_report(self):
        self.assertEqual(
            ...
            ("context-merit-audit-report-v284", {"drop": 0, "edit": 1, "keep": 0}, b.EXPECTED_OUTPUT_SHA256),
        )
