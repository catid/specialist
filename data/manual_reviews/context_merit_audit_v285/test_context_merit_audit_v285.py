#!/usr/bin/env python3
"""Focused regression tests for the v285 inversion-injury normalization."""
import json
import sys
import tempfile
import unittest
...
import build_context_merit_audit_v285 as b


class V285(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temp = tempfile.TemporaryDirectory(prefix=".test-v285-", dir=HERE)
    ...
    def test_19_report(self):
        self.assertEqual(
            ...
            ("context-merit-audit-report-v285", {"drop": 0, "edit": 1, "keep": 0}, b.EXPECTED_OUTPUT_SHA256),
        )
