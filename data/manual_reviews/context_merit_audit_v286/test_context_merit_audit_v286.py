#!/usr/bin/env python3
"""Focused regression tests for the v286 gote wrist-slack safety edit."""
import json
import sys
import tempfile
import unittest
...
import build_context_merit_audit_v286 as b


class V286(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temp = tempfile.TemporaryDirectory(prefix=".test-v286-", dir=HERE)
    ...
    def test_19_report(self):
        self.assertEqual(
            ...
            ("context-merit-audit-report-v286", {"drop": 0, "edit": 1, "keep": 0}, b.EXPECTED_OUTPUT_SHA256),
        )
