#!/usr/bin/env python3
"""Focused regression tests for the v288 pre-session negotiation edit."""
import json
import sys
import tempfile
import unittest
...
import build_context_merit_audit_v288 as b


class V288(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temp = tempfile.TemporaryDirectory(prefix=".test-v288-", dir=HERE)
    ...
    def test_19_report(self):
        self.assertEqual(
            ...
            ("context-merit-audit-report-v288", {"drop": 0, "edit": 1, "keep": 0}, b.EXPECTED_OUTPUT_SHA256),
        )
