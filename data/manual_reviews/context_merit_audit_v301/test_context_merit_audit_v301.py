...
import build_context_merit_audit_v301 as b


class ContextMeritV301(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temp = tempfile.TemporaryDirectory(prefix=".test-v301-", dir=HERE)
    ...
    def test_inputs(self):
        self.assertEqual((len(b.read_jsonl(self.baseline)), b.file_sha256(self.baseline)), (525, b.BASELINE_SHA256))
    ...
    def test_audit_projection(self):
        ...
        self.assertEqual((len(self.rows), b.file_sha256(self.output)), (528, b.EXPECTED_OUTPUT_SHA256))
    ...
    def test_checkpoint(self):
        self.assertEqual(self.report["prior_checkpoint"]["candidate"], {"rows": 525, "sha256": b.BASELINE_SHA256})
    ...
    def test_urls_capacity(self):
        ...
        self.assertEqual(self.report["conservative_capacity"]["delta"], {"conflict_units": 3, "equipment_material": 1, "resources_general": 0, "safety_consent": 2, "technique": 0})

    def test_report(self):
        self.assertEqual((self.report["schema"], self.report["isolated_build_projection"]["output_sha256"]), ("context-merit-audit-report-v301", b.EXPECTED_OUTPUT_SHA256))
