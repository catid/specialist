#!/usr/bin/env python3
"""Focused regression tests for the v280 UV-and-wipes normalization."""
import json
import sys
import tempfile
import unittest
...
import build_context_merit_audit_v280 as b


class V280(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temp = tempfile.TemporaryDirectory(prefix=".test-v280-", dir=HERE)
    ...
    def test_19_report(self):
        self.assertEqual(
            ...
            ("context-merit-audit-report-v280", {"drop": 0, "edit": 1, "keep": 0}, b.EXPECTED_OUTPUT_SHA256),
        )
