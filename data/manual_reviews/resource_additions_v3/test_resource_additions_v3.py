#!/usr/bin/env python3
"""Regression tests for the third distinct-document resource tranche."""
...
class ResourceAdditionsV3(unittest.TestCase):
    ...
    def test_03_content(self) -> None:
        ...
        self.assertEqual(Counter(classify_stratum(row) for row in self.rows), Counter({"resources_general": 3}))

    def test_04_report(self) -> None:
        self.assertEqual(self.report["new_independent_inputs"], {"document_sha256s": 3, "expected_strata": {"resources_general": 3}, "urls": 3})
