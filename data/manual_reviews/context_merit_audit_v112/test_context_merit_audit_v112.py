#!/usr/bin/env python3
"""Focused regression tests for Esinem suspension-prerequisite audit v112."""
import json
import sys
import tempfile
import unittest
...
import build_context_merit_audit_v112 as b


class V112(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temp = tempfile.TemporaryDirectory(prefix=".test-v112-", dir=HERE)
    ...
    def test_10_lineage(self):
        for row in self.audit:
            self.assertEqual(
                ...
                ("esinem_suspension_prerequisite_reaudit", b.PROJECTED_SELECTION_BASELINE["sha256"]),
            )
    ...
    def test_19_report(self):
        self.assertEqual(
            ...
            ("context-merit-audit-report-v112", {"drop": 0, "edit": 0, "keep": 1}, b.EXPECTED_OUTPUT_SHA256),
        )
