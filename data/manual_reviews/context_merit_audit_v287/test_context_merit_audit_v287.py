#!/usr/bin/env python3
"""Focused regression tests for the v287 suspension-prerequisite edit."""
import json
import sys
import tempfile
import unittest
...
import build_context_merit_audit_v287 as b


class V287(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temp = tempfile.TemporaryDirectory(prefix=".test-v287-", dir=HERE)
    ...
    def test_19_report(self):
        self.assertEqual(
            ...
            ("context-merit-audit-report-v287", {"drop": 0, "edit": 1, "keep": 0}, b.EXPECTED_OUTPUT_SHA256),
        )
