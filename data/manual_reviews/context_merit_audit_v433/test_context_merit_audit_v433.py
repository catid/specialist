...
import build_context_merit_audit_v433 as b


class ContextMeritV433(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        b.main()
        cls.tmp = tempfile.TemporaryDirectory(prefix=".test-v433-", dir=HERE)
        d = Path(cls.tmp.name)
    ...
    def test_source_evidence_and_url_gate(self):
        self.assertEqual(
